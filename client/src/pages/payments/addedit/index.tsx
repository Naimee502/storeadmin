...
const AddEditPayment = () => {
  ...
  useEffect(() => {
    if (isEdit && existingData?.getPaymentById) {
      ...
      setFormValues({
        ...
        ledgerid: typeof p.ledgerid === "string"
          ? p.ledgerid
          : p.ledgerid?.id || p.ledgerid?._id || "",
  ...
  const validate = () => {
    ...
    if (!formValues.ledgerid) errors.ledgerid = "Select a ledger account";

    const amount = parseFloat(formValues.amount as any);
        ...
        <fieldset className="border rounded-xl p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
            ...
            <FormField
              ...
              options={ledgerData?.getAccountLedgers.map(l => ({ label: l.ledgername, value: l.id }))}
