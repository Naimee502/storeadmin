...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar, onHoverChange }) => {
  ...
  const ALL_LINKS: (SidebarLink & { roles: string[]; section?: string })[] = [
    ...
    { to: '/staffaccounts', label: 'Staff Accounts', icon: <FaUserTie className="text-indigo-400 text-xl flex-shrink-0" />, moduleId: "staffaccounts", roles: ["admin", "branch", "staff"], section: "Branch" },
    { to: '/accounts', label: 'Party Accounts', icon: <FaUser className="text-pink-400 text-xl flex-shrink-0" />, moduleId: "accounts", roles: ["admin", "branch", "staff"], section: "Branch" },
