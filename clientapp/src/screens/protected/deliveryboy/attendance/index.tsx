...
const DUMMY_SUMMARY = { present: 17, absent: 3, leave: 1, totalWorkingDays: 21 };

const DUMMY_LOGS = [
  { id: 'l1', date: '2024-11-15', status: 'present', inTime: '08:45', outTime: '18:30', totalWorkMinutes: 585 },
  { id: 'l2', date: '2024-11-14', status: 'present', inTime: '08:50', outTime: '18:15', totalWorkMinutes: 565 },
  { id: 'l3', date: '2024-11-13', status: 'absent',  inTime: null,    outTime: null,    totalWorkMinutes: 0   },
  { id: 'l4', date: '2024-11-12', status: 'present', inTime: '09:00', outTime: '18:00', totalWorkMinutes: 540 },
  { id: 'l5', date: '2024-11-11', status: 'present', inTime: '08:55', outTime: '18:10', totalWorkMinutes: 555 },
  { id: 'l6', date: '2024-11-10', status: 'leave',   inTime: null,    outTime: null,    totalWorkMinutes: 0   },
  { id: 'l7', date: '2024-11-09', status: 'present', inTime: '09:05', outTime: '18:20', totalWorkMinutes: 555 },
  { id: 'l8', date: '2024-11-08', status: 'absent',  inTime: null,    outTime: null,    totalWorkMinutes: 0   },
];

const DUMMY_LEAVES_INIT = [
  { id: 'lv1', type: 'Sick Leave',   typeColor: '#22c55e', fromDate: '2024-11-22', toDate: '2024-11-22', totalDays: 1, reason: 'Fever',           status: 'pending'  },
  { id: 'lv2', type: 'Casual Leave', typeColor: '#6366f1', fromDate: '2024-11-10', toDate: '2024-11-10', totalDays: 1, reason: 'Personal errand', status: 'approved' },
];
      ...
      <Animated.View entering={FadeInUp.duration(400).delay(120)} style={[styles.punchCard, { backgroundColor: colors.cardGlass, borderColor: colors.border }]}>
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.punchRow}>
            ...
            <Text style={[styles.punchMeta, { color: colors.subText }]}>In: 08:45 AM</Text>
