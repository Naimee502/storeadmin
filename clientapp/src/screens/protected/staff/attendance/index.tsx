...
const DUMMY_SUMMARY = { present: 19, absent: 1, leave: 1, totalWorkingDays: 21 };

const DUMMY_LOGS = [
  { id: 'l1', date: '2024-11-15', status: 'present', inTime: '09:10', outTime: '18:05', totalWorkMinutes: 535 },
  { id: 'l2', date: '2024-11-14', status: 'present', inTime: '09:00', outTime: '18:00', totalWorkMinutes: 540 },
  { id: 'l3', date: '2024-11-13', status: 'present', inTime: '08:55', outTime: '18:10', totalWorkMinutes: 555 },
  { id: 'l4', date: '2024-11-12', status: 'absent',  inTime: null,    outTime: null,    totalWorkMinutes: 0   },
  { id: 'l5', date: '2024-11-11', status: 'present', inTime: '09:05', outTime: '17:55', totalWorkMinutes: 530 },
  ...
  { id: 'l8', date: '2024-11-08', status: 'present', inTime: '09:15', outTime: '18:20', totalWorkMinutes: 545 },
];

const DUMMY_LEAVES_INIT = [
  { id: 'lv1', type: 'Earned Leave',  typeColor: '#f59e0b', fromDate: '2024-11-25', toDate: '2024-11-26', totalDays: 2, reason: 'Family function', status: 'pending'  },
  { id: 'lv2', type: 'Casual Leave',  typeColor: '#6366f1', fromDate: '2024-11-10', toDate: '2024-11-10', totalDays: 1, reason: 'Personal work',   status: 'approved' },
];
    ...
    <>
      ...
      <Animated.View entering={FadeInUp.duration(400).delay(120)} style={[styles.punchCard, { backgroundColor: colors.cardGlass, borderColor: colors.border }]}>
        <View style={{ flex: 1 }}>
          ...
          <Text style={[styles.punchMeta, { color: isPunchedIn ? '#22c55e' : colors.subText }]}>
            {isPunchedIn ? 'Currently active' : 'Not yet punched in'}
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  punchTitle: { fontSize: 14, fontFamily: FONTS.bold, marginBottom: 4 },
