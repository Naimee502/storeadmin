...
const DUMMY_ACCOUNT = {
  staffcode: '#STF001', role: 'Staff', mobile: '9876500002',
  email: 'staff1@example.com', branch: 'Main Branch',
};
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        <Animated.View entering={FadeInUp.duration(400).delay(60)}>
          <LinearGradient colors={[colors.brandSoft, colors.cardGlass]} style={[styles.avatarCard, { borderColor: colors.border }]}>
            ...
            <Text style={[styles.userName, { color: colors.text }]}>{user?.name ?? 'Staff'}</Text>
            <View style={[styles.roleBadge, { backgroundColor: colors.brand + '22' }]}>
              <Icon name="account-outline" size={12} color={colors.brand} />
