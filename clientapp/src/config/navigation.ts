...
export const Screens: any = {
  ...
  MyOrders,
  Ledger,
  PartyLedgerView: Ledger,
  LedgerDetail,
  Payments,
  PartyPaymentsView: Payments,
  PaymentDetail,
  PartyProfile,
  ProductDetail,
  OrderDetail,
...
export const NavConfig: any = {
  ...
  party: {
    ...
    screens: [
      ...
      // Ledger stays reachable from the drawer even though it's no longer a
      // bottom tab for party logins.
      { name: 'Ledger',        options: { headerShown: false } },
      ...
      { name: 'PartyLedgerView',   options: { headerShown: false } },
  ...
  salesman: {
    ...
    screens: [
      ...
      { name: 'SalesmanParties', options: { headerShown: false } },
    ],
  },
